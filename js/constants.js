...
export const UI_IDS = Object.freeze({
  ...
  quickfireSelectModal: "quickfireSelectModal",
...
// Kept for compatibility; values are only used for AI math and defaults.
// All rendering uses live DOM measurements now (see ui.js).
